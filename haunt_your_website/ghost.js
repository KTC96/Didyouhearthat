...
var arr_ghost_talking = [
  ...
  "I love spooky stories. I hope I can be one to you.",
  "I hope I can be something that keeps you up at night. I am an ambitious ghost!",
...
function interval_move_ghost() {
  ...
  //check
  if (
    parseInt(tatghoul.style.left) == num_targ_x ||
    parseInt(tatghoul.style.top) == num_targ_y ||
    num_travelCnt <= 1
  ) {
    clearInterval(int_ghost);
...
function ghost_init(show_bootup) {
  ...
  bootup.innerHTML =
    "<img src=" + str_path_ghost + "images/IMG_GHOST_BOOTUP.gif" + ">";
  ...
  ghost_sleep.innerHTML =
    "<img src=" + str_path_ghost + "images/IMG_GHOST_SLEEPING.gif" + ">";
  //booing
  ...
  ghost_boo.innerHTML =
    "<img src=" + str_path_ghost + "images/IMG_GHOST_BOO.gif" + ">";
  //talking
  ...
  ghost_talk.innerHTML =
    "<img src=" + str_path_ghost + "images/IMG_GHOST_TALKING.gif" + ">";
  //default (idle)
  ...
  ghost_default.innerHTML =
    "<img src=" + str_path_ghost + "images/IMG_GHOST_DEFAULT.gif" + ">";
  //
